...
const DisplayMenuItem PROGMEM Menu[] = {
        ...
        {.id = MENU_ID_LIGHT_CB,        .parentId = MENU_ID_ROOT, .text = TXT_MENU_LIGHT, .flags = MENU_DEFAULT},
        {.id = MENU_ID_BLUETOOTH_CB,    .parentId = MENU_ID_ROOT, .text = TXT_MENU_BLUETOOTH, .flags = MENU_DEFAULT},
        {.id = MENU_ID_PROFIL_CB,       .parentId = MENU_ID_ROOT, .text = TXT_MENU_PROFIL, .flags = MENU_DEFAULT},
        ...
        {.id = MENU_ID_EM_POTI_CB,      .parentId =  MENU_ID_EMERGENCY,.text = TXT_MENU_EM_POTI, .flags = MENU_CHECKBOX},
        {.id = MENU_ID_ADD_POTI_CB,     .parentId = MENU_ID_EMERGENCY, .text = TXT_MENU_ADD_POTI, .flags = MENU_DEFAULT},
        {.id = MENU_ID_DEC_POTI_CB,     .parentId = MENU_ID_EMERGENCY, .text = TXT_MENU_DEC_POTI, .flags = MENU_DEFAULT},
